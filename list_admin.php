...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#NewAdmin">Add New Admin</a>
                            ...
                            <td><?= $ad['name']; ?></td>
                             ...
                             <td><?= $ad['password']; ?></td>
                              ...
                              <td>
                                ...
                                <a href="<?= base_url(); ?>admin/edit_admin/<?= $ad['id']; ?>" class="badge badge-warning" >Edit</a>
                                <a href="<?= base_url(); ?>admin/hapus_admin/<?= $ad['id']; ?>" class="badge badge-danger" onclick="return confirm('Are you sure?');">Delete</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="NewAdminLabel">Add New Admin</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <!-- FORM -->
            <form action="<?= base_url('admin/list_admin'); ?>" method="post">
